...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/*The inner function is going outside of it's scope to grab the internal variable from the parent function  */
...
console.log('Topic 2: Request 1 .forEach 🦁',animalNames(zooAnimals));
  ...
  */
  ...
  console.log('Topic 2: Request 2 .map 🦁',lowerCaseNames(zooAnimals));
  ...
  */
  ...
  console.log('Topic 2: Request 3 .filter 🦁',lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  function USApop(array){
    const totalPops = array.reduce (function(accumulator,item){ 
  ...
  console.log('Topic 2: Request 4 .reduce 🦁',USApop(zooAnimals));
